...
#define JSI_STUBS_MD5 "61fe29f90bece60d3666e04c326eedac"
...
typedef struct Jsi_Stubs {
    ...
    Jsi_RC(*_Jsi_InterpAccess)(Jsi_Interp *interp, Jsi_Value* file, int toWrite);
    ...
    Jsi_RC(*_Jsi_PkgProvide)(Jsi_Interp *interp, const char *name, Jsi_Number version, Jsi_InitProc *initProc);
    Jsi_Number(*_Jsi_PkgRequire)(Jsi_Interp *interp, const char *name, int version);
    ...
    Jsi_RC(*_Jsi_DatetimeParse)(Jsi_Interp *interp, const char *str, const char *fmt, int isUtc, Jsi_Number *datePtr);
    ...
    Jsi_RC(*_Jsi_CryptoHash)(char *outbuf, const char *str, int len, Jsi_CryptoHashType type, uint strength, bool noHex);
    Jsi_RC(*_Jsi_Base64)(const char *str, int len, Jsi_DString *buf, bool decode);
    void(*_Jsi_ToHexStr)(const uchar *indata, int inlen, char *out);
    int(*_Jsi_FromHexStr)(const char *in, uchar *outdata);
    ...
    void(*_Jsi_NumberItoA10)(int value, char* buf, int bsiz);
    void(*_Jsi_NumberUtoA10)(unsigned int value, char* buf, int bsiz);
    ...
    const Jsi_OptionType*(*_Jsi_OptionTypeInfo)(Jsi_OptionId typ);
    Jsi_OptionType*(*_Jsi_TypeLookup)(Jsi_Interp* interp, const char *typ);
    ...
    int(*_Jsi_Truncate)(Jsi_Channel chan, uint len);
    ...
    int(*_Jsi_Puts)(Jsi_Channel chan, const char *str);
...
#define Jsi_PkgProvide(n0,n1,n2,n3) JSISTUBCALL(jsiStubsPtr, _Jsi_PkgProvide(n0,n1,n2,n3))
...
#define Jsi_CryptoHash(n0,n1,n2,n3,n4,n5) JSISTUBCALL(jsiStubsPtr, _Jsi_CryptoHash(n0,n1,n2,n3,n4,n5))
#define Jsi_Base64(n0,n1,n2,n3) JSISTUBCALL(jsiStubsPtr, _Jsi_Base64(n0,n1,n2,n3))
#define Jsi_ToHexStr(n0,n1,n2) JSISTUBCALL(jsiStubsPtr, _Jsi_ToHexStr(n0,n1,n2))
#define Jsi_FromHexStr(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_FromHexStr(n0,n1))
...
#define Jsi_Printf(n0,n1,...) JSISTUBCALL(jsiStubsPtr, _Jsi_Printf(n0,n1,##__VA_ARGS__))
...
#define Jsi_Puts(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_Puts(n0,n1))

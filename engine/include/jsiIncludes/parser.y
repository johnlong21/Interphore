...
func_statement:
    func_prefix '(' args_opt ')' ':' rettype func_statement_block {
        Jsi_OpCodes *ret = codes_join4(code_push_index(pstate, &@1, $1, 0),
          code_push_func(pstate, &@3, jsi_FuncMake(pstate, $3, $7, &@1, $1)),
    ...
    | func_prefix '(' args_opt ')' func_statement_block {
        Jsi_OpCodes *ret = codes_join4(code_push_index(pstate, &@1, $1, 0),
          code_push_func(pstate, &@3, jsi_FuncMake(pstate, $3, $5, &@1, $1)),
          code_assign(pstate, &@1, 1), code_pop(1));
        if (pstate->eval_flag) ret = codes_join(code_local(pstate, &@1, $1), ret);
        jsi_PstatePop(pstate);
        $$ = ret;
...
vardec:
    IDENTIFIER              {
        Jsi_OpCodes *ret = codes_join4(code_push_index(pstate, &@1, $1, 1),
                            ...
                            code_pop(1));
        if (!pstate->eval_flag) jsi_PstateAddVar(pstate, $1);
...
func_expr:
    ...
    | FUNC '(' args_opt ')' ':' rettype func_statement_block {
        $$ = code_push_func(pstate,  &@3, jsi_FuncMake(pstate, $3, $7, &@7, NULL));
        jsi_PstatePop(pstate);
    }
    ...
    | FUNC IDENTIFIER '(' args_opt ')' ':' rettype func_statement_block {
        $$ = code_push_func(pstate, &@3, jsi_FuncMake(pstate, $4, $8, &@8, $2));
        jsi_PstatePop(pstate);
    }
;
...
args:
    ...
    | args ',' IDENTIFIER '=' argdefault { $$ = jsi_argInsert(pstate, $1, $3, $5, &@1); }
    | args ',' IDENTIFIER ':' argtype { $$ = jsi_argInsert(pstate, $1, $3, NULL, &@1);}
    | args ',' IDENTIFIER ':' argtype '=' argdefault { $$ = jsi_argInsert(pstate, $1, $3, $7, &@1);}
;
